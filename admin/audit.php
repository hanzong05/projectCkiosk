...
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.13.1/js/jquery.dataTables.min.js"></script>
  ...
  <script>$(document).ready(function() {
    $('#auditTable').DataTable({
        ...
        "lengthChange": false,  // Disable change of number of records per page
        "pageLength": 10,  // Set default records per page
        "responsive": true,  // Make the table responsive
        "order": [[1, "desc"]], // Default order by the second column (Date)
        "columnDefs": [
            { "orderable": true, "targets": [1, 2] } // Make Date and Message sortable
        ],
