...
$memberInfo  = $obj->admin_account();
 
if ($memberInfo) {
  // Now you can safely access array offsets
  $username = $memberInfo['users_username']; 
...
if (isset($_POST['save_profile'])) {
  $log_msg = $obj->save_user_profile($_POST);
}
?>
<!DOCTYPE html>
    <html lang="en">
            ...
            <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                ...
                <form id="editProfileForm" method="POST" action="update_profile.php" class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="mt-1 block w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" id="editUsername" name="username" value="<?php echo htmlspecialchars($memberInfo['users_username']); ?>" required readonly>
                    </div>
                     <div class="mb-4">
                        <label for="editorg" class="block text-sm font-medium text-gray-700">Org</label>
                        <input type="text" class="mt-1 block w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" id="editorg" name="org" value="<?php echo htmlspecialchars($memberInfo['org_name']); ?>" required readonly>
                    </div>
                  
                   
                    <input type="hidden" id="editId" name="id" value="<?php echo htmlspecialchars($memberInfo['users_id']); ?>">
                    
                    <button type="button" class=" accountModalEdit mt-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-200" data-toggle="modal" data-target="#accountModalEdit" data-id="<?= $memberInfo['users_id'] ?>">
                        Edit Account
                    </button>
                </form>
            </div>
