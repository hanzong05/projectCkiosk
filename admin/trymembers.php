...
<body class=""><div class="wrapper ">
    ...
    <div class="mb-4">
        <div class="flex space-x-2">
            <button class="tab-button active bg-blue-600 text-white px-4 py-2 rounded-md" onclick="openTab(event, 'ccs')">CCS</button>
            <button class="tab-button bg-gray-300 text-gray-800 px-4 py-2 rounded-md hover:bg-gray-400" onclick="openTab(event, 'cit')">CIT</button>
            <button class="tab-button bg-gray-300 text-gray-800 px-4 py-2 rounded-md hover:bg-gray-400" onclick="openTab(event, 'cafa')">CAFA</button>
        </div>
    </div>
    <!-- Floor Map Section -->
