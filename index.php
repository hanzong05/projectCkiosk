...
@media (max-width: 576px) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('input[name="feedback_category"]').forEach(input => {
            input.addEventListener('change', function() {
                ...
                if (category === 'office') {
                    officeQuestions.style.display =officeQuestions.style.display = 'block';
        ...
        // Validation functions - Modified to remove SQD0
    function validateOfficeForm() {
        ...
        // Validate SQD ratings - MODIFIED to start from SQD1 instead of SQD0
        for (let i = 1; i <= 8; i++) {
...
.then(data => {
    if (data.success) {
        ...
        // ADDED: Remove any modal backdrops and prevent room details modal from showing
        document.querySelectorAll('.modal-backdrop').forEach(el => el.remove());
        document.body.classList.remove('modal-open');
        document.body.style.overflow = '';
        
        // ADDED: Hide any open modals
        const roomDetailsModal = document.getElementById('roomDetailsModal');
        if (roomDetailsModal) {
            const bsModal = bootstrap.Modal.getInstance(roomDetailsModal);
